...
import com.arteriatech.ss.msecsales.rspl.reports.collection.pendingcollection.CollectionPendingSyncFragment;
...
public class CollectionListActivity extends AppCompatActivity {
    ...
    CollectionListFragment salesOrderHeaderListFragment=null;
    CollectionPendingSyncFragment deviceOrderListFragment;
    Toolbar toolbar;
    private String TAG= CollectionListActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!Constants.restartApp(CollectionListActivity.this)) {
            initializeUI();
        }
    }
    void initializeUI(){
        ...
        ConstantsUtils.initActionBarView(this, toolbar, true, getString(R.string.title_coll_history),0);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        salesOrderHeaderListFragment = new CollectionListFragment();
        deviceOrderListFragment =new CollectionPendingSyncFragment();
