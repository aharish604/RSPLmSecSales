...
public class VisualAidActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConstantsUtils.initActionBarView(this, toolbar, true, getString(R.string.visual_aidl_title), 0);
        if (savedInstanceState == null) {
            Fragment fragment = new VisualAidFragment();
    ...
    protected void onStop() {
        super.onStop();
        Constants.deleteFolder(VisualAidActivity.this);
    }
