package com.arteriatech.ss.msecsales.rspl.ui.fabTnsfmgToolBar;
...
public class FABToolbarLayout extends RelativeLayout {
    ...
    public int originalToolbarSize = -1;
            ...
            public void onGlobalLayout() {
                if (toolbarLayout.getWidth() != 0 || toolbarLayout.getHeight() != 0) {
                    ...
                    if(originalToolbarSize == -1) {
                        System.out.println("Screen Size"+toolbarSize.y);
                        originalToolbarSize = toolbarSize.y;
                        System.out.println("Screen Size1"+originalToolbarSize);
