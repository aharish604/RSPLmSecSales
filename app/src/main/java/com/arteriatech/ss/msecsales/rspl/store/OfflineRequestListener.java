...
public class OfflineRequestListener implements ODataRequestListener {
    ...
    public OfflineRequestListener(int operation, UIListener uiListener, String collectionName,Context context) {
        super();
                ...
                try {
                    ...
                    if (oDataRequestParamSingle.getResourcePath().equalsIgnoreCase(Constants.MerchReviewImages)) {
                        ...
                        if (payload != null && payload instanceof ODataEntity) {
                            ...
                            try {
                                Constants.storeInDataVault(mStrMerHeaderGuid.toUpperCase(), oEntity.getMediaLink().toString(),context);
                            } catch (Throwable e) {
                                e.printStackTrace();
                            }
                        }
