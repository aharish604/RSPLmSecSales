...
public class ReturnOrderListSyncFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, AdapterInterface<SalesOrderBean>, ReturnOrderListView {
    ...
    public ReturnOrderListSyncFragment() {
    ...
    public void onItemClick(SalesOrderBean salesOrderBean, View view, int i) {
        presenter.getPendingDetails(salesOrderBean.getSSROGUID());
